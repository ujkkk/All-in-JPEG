...
class AiLoadResolver() {
     ...
     */
    suspend fun imageContentParsing(AiContainer: AiContainer, sourceByteArray: ByteArray,
                                    imageInfoByteArray: ByteArray, isBurstMode : Int)
    : ArrayList<Picture> = withContext(Dispatchers.Default) {
        var picture : Picture
