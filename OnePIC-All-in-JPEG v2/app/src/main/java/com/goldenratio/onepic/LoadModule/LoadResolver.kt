        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            if (APP3_startOffset == - 1) {
                ...
                try{
                    ...
                    var imageContentInfoSize = ByteArraytoInt(sourceByteArray, APP3_startOffset + 6)
                    var pictureList = async {
                        imageContentParsing(
                            ...
                            sourceByteArray.copyOfRange(
                                APP3_startOffset + 10,
                                APP3_startOffset + 14 + imageContentInfoSize
                            )
                        )
                    }
                    ...
                    var textContentStartOffset = APP3_startOffset + 6 + imageContentInfoSize
...
//        startIndex++
        ...
        for(i in 0..imageCount -1){
            ...
            if(i==0){
                ...
                val app1Segment = sourceByteArray.copyOfRange(offset + 2, offset + 2 + app1DataSize - 1)
                val imageData = sourceByteArray.copyOfRange(offset + 2 + app1DataSize, offset + 2 + app1DataSize + size - 1)
                // picture 생성
